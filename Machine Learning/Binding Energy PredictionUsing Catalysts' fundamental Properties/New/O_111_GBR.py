...
filename = os.path.join(dirname, 'Featured_data_O_111_f1.xlsx')
GBR_model_name = os.path.join(dirname, 'GBR_O_111_new.pickle')
...
with open('GBR_O_111_results_'+str(X_train.shape[1]) +'_features.txt', 'w') as f:
