...
csv_file_name = 'classification_report_xgb' + lda_model_name.split('.')[0] + str(n) + ' % others' + '.csv'
fig_name = 'confusion_matrix_xgb' + lda_model_name.split('.')[0] + str(n) + '% others' + '.png'
supervised_model = 'Supervised_xgb'  + lda_model_name.split('.')[0] + str(n) + '% others' + '.joblib'
...
dump(best_model, supervised_model)
