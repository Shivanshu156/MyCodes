...
fig_name = 'confusion_matrix_'+ hierarchical_model_name.split('.')[0] + '.png'
supervised_model = 'Supervised_svm_'+ hierarchical_model_name.split('.')[0] + '.joblib'
...
Hierarchical_model = load(hierarchical_model_name)
feature = Hierarchical_model.transform(X_super)
