...
# print(list(X_val))
trained_classifier = RandomForestClassifier(n_estimators=100,criterion='gini', max_depth=None, min_samples_split=10, min_samples_leaf=5)
...
print('Accuracy using Random Forest Classifiers is {}%'.format(accuracy*100))
